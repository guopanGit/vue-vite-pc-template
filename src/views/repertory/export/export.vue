<template>
  <div class="box">
    <div class="box-top">
      <n-button type="info" @click="data.drawer = true">新建出库单</n-button>
      <n-drawer v-model:show="data.drawer" :width="1200">
        <n-drawer-content title="新建出库单" closable>
          <n-form label-placement="left">
            <n-space size="large">
              <n-form-item label="出库时间:">
                <n-date-picker v-model:value="data.newDate" disabled type="date" />
              </n-form-item>
              <n-form-item label="出库部门:">
                <n-input v-model:value="data.source" type="text" style="width: 240px" placeholder="请输入出库部门" />
              </n-form-item>
              <n-form-item label="项目名称:">
                <n-input v-model:value="data.itemName" type="text" style="width: 240px" placeholder="请输入项目名称" />
              </n-form-item>
            </n-space>
            <n-space size="large">
              <n-form-item label="经 办 人:">
                <n-input v-model:value="data.name1" type="text" style="width: 240px" placeholder="请输入经办人" />
              </n-form-item>
              <n-form-item label="备 &nbsp &nbsp 注:">
                <n-input v-model:value="data.text" type="text" style="width: 340px" placeholder="请输入备注" />
              </n-form-item>
            </n-space>
          </n-form>
          ...
          <n-space justify="end">
            ...
            <n-button type="info" ghost @click="add">新增一列</n-button>
          </n-space>
          <n-divider />
          <n-space justify="end">
